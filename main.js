...
const canvas = document.createElement('sneakerCanvas');
...
const renderer = new THREE.WebGLRenderer({ alpha: true, antialias: true, canvas : document.getElementById("sneakerCanvas") });
